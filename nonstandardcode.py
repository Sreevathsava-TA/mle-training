...
# Add income category column for stratified sampling
...
# Remove the income_cat column now that stratified sampling is done
for set_ in (strat_train_set, strat_test_set):
    set_.drop("income_cat", axis=1, inplace=True)

# Copy the training data for exploration
...
# Adding features again after transformation
